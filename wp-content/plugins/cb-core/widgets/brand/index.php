 ...
 * @since 1.0.0
 */
class CB_Core_Brand extends Widget_Base
{
	...
	protected function register_controls()
	{
        ...
        $repeater->add_control(
         ...
         $repeater->add_control(
          'brand_image',
          [
            'label'   => esc_html__( 'Brand Image', 'cb-core' ),
...
Plugin::instance()->widgets_manager->register(new CB_Core_Brand());
