	...
	protected function register_controls()
	{
        ...
        $repeater->add_control(
         ...
         $repeater->add_control(
          'testimonial_rating',
          [
            'label'   => esc_html__( 'Testimonial Rating', 'cb-core' ),
         ...
         $repeater->add_control(
          'testimonial_text',
          [
            'label'   => esc_html__( 'Testimonial Text', 'cb-core' ),
            'type'    => \Elementor\Controls_Manager::TEXTAREA,
            'label_block' => true,
            'condition' => [
                'field_condition' => ['style-1']
            ],
            'default' => "The product's speed of delivering an answer to a user decreased from 30 seconds to 10. Neuron was easy to work with and made the engagement seamless.",
          ]
         );
         $repeater->add_control(
          'author_image',
         ...
         $repeater->add_control(
          ...
          [
            ...
            'default' => "Halász Emese / CEO / Gemetric Agency",
          ]
         );
         ...
         $this->add_control(
           'slides',
           [
             'label'       => esc_html__( 'Brands', 'cb-core' ),
             'type'        => \Elementor\Controls_Manager::REPEATER,
             'fields'      => $repeater->get_controls(),
             'title_field' => '{{{ author_name_designation }}}',
           ]
         );
		$this->end_controls_section();
	}
