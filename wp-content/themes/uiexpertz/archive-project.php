            ...
            <div class="uiexpertz-archive-project-tab-buttons-114">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-tab0-tab" data-bs-toggle="tab" data-bs-target="#nav-tab0" type="button" role="tab" aria-controls="nav-tab0" aria-selected="true">All</button>
                        <?php if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) : ?>
                            <?php foreach ( $terms as $index => $term ) : ?>
                                <button class="nav-link" id="nav-tab<?php echo $index+1; ?>-tab" data-bs-toggle="tab" data-bs-target="#nav-tab<?php echo $index+1; ?>" type="button" role="tab" aria-controls="nav-tab<?php echo $index+1; ?>" aria-selected="false"><?php echo esc_html( $term->name ); ?></button>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
                </nav>
        ...
        <div class="tab-content" id="uiexprtz-project-nav-tabContent">
            ...
            <?php if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) : ?>
                <?php foreach ( $terms as $index => $term ) : 
                    ...
                    ?>
                    <div class="tab-pane fade" id="nav-tab<?php echo $index+1; ?>" role="tabpanel" aria-labelledby="nav-tab<?php echo $index+1; ?>-tab">
                    <?php if(have_posts()) : ?>
