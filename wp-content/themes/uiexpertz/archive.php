            ...
            <div class="searchBar position-absolute " style="display: block;">
                    <form id="searchForm" action="#" method="POST">
                        <div class="search-wrap position-relative">
                            <input value="<?php echo get_search_query(); ?>"  type="text" class="form-control px-4 text-clr-gray fs-14 fw-normal" name="search" placeholder="Search.." id="searchInput">
            ...
            <div class="tab-pane fade <?php echo $active_class; ?>" id="pills-all" role="tabpanel" tabindex="0">
                ...
                <div>
                    <div class="">
                        ...
                        <?php endif; ?>
                        <button class="ajax-load-more-all-blog wb-blog-load-more-btn w-auto mx-auto mt-5 text-decoration-none position-relative bg-btn banner-btn border-0 bg-clr-darkBlue text-white fs-14 fw-extraBold d-flex gap-2 align-items-center">
                            Load more
                ...
                <div class="blogCart-section-title">
                    ...
                    <div>
                        <div class="">
                            ...
                            ?>
                            <?php if($fetch_all_posts->have_posts()): ?>
                            <div class="row mt-4" id="hom132ae-filtered-blog-post-1142">
                                <?php while($fetch_all_posts->have_posts()) : $fetch_all_posts->the_post(); ?>
                                <div class="col-lg-4 col-md-6">
                                    <div class="service-item js-text-cursor-block  service-item-wrap bg-white mb-4 pb-3">
