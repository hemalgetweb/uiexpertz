...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_lvl( &$output, $depth = 0, $args = null, $id=0 ) {
            ...
            <li class="uiexpertz-mobile-menu-bottom-pos-114">
                <a href="#" class="first"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                </svg> <span>+88 012 458 368</span></a>
                <a href="#" class="last">Let’s talk <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        public static function fallback( $args ) {
            ...
            $fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'uiexpertz' ) . '">' . esc_html__( 'Add a menu', 'uiexpertz' ) . '</a></li>';
            $fallback_output .= '</ul>';
