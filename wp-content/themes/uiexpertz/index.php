                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="d-flex justify-content-center gap-3">
                            <select class="form-select form-control uiexperts-blog-category-filter" aria-label="Default select example">
                                <option selected="">All Services</option>
								<?php foreach ($categories as $category): ?>
									<option value="<?php echo esc_attr($category->term_id); ?>"><?php echo $category->name; ?></option>
								<?php endforeach; ?>
                            </select>
                            <select class="form-select uiexpertz-has-duration-select form-control" aria-label="Default select example">
                    ...
                    <div class="col-xl-6">
                        <div class="blog-search">
                            <input type="search" placeholder="Search" class="search-control uiexpertz-blog-search">
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-5" id="home-filtered-blog-post-114">
                <div class="row">
					<?php
						while(have_posts()) :
						the_post();
