...
$cbtoolkit_blog_category_select = get_theme_mod('cbtoolkit_blog_category_select', array(1, 41));
...
<!--sub banner -->
<div class="blog-page-wrap subBanner bg-clr-blue fs-6 ">
    <div class="container">
            ...
            <div class="tab-pane fade <?php echo $active_class; ?>" id="pills-all" role="tabpanel" tabindex="0">
                ...
                <div>
                    <div class="">
                        ...
                        <?php endif; ?>
                        <button class="ajax-load-more-all-blog w-auto mx-auto mt-md-5 mt-2 text-decoration-none position-relative bg-btn banner-btn border-0 bg-clr-darkBlue text-white fs-14 fw-extraBold d-flex gap-2 align-items-center">
                            Load more
