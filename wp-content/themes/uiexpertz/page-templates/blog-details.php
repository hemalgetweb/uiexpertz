...
<div class="wb-blog-details">
    <div class="container">
        ...
        <h1>Fruitcake toffee tiramisu cookie dragée shortbread tootsie roll sugar plum.</h1>
        <div class="d-flex align-items-center gap-3">
            <a href="#"
                class="fs-12 fw-medium ls-1 text-uppercase text-decoration-none px-2 py-1 bg-clr-lightPink">UX/UI
                Design</a>
            <span class="fs-12 fw-medium text-clr-gray ls-1 text-uppercase">March 17, 2023</span>
        </div>
        <div class="blog-details-img mt-4">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog-details.png" alt="banner img"
                class="img-fluid">
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div>
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto rerum dolores, dolorem quos
                            vitae fugit placeat. Cupiditate facilis eos pariatur quibusdam, sunt doloribus molestias
                            earum? Rerum et explicabo magnam, delectus numquam, nihil atque, quasi repudiandae
                            laudantium esse enim a deleniti? Explicabo et ab, ad autem reiciendis doloribus fugit odio
                            suscipit veniam, qui voluptatibus quas tenetur iste minima ipsum esse nesciunt?
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="categories mb-5">
                        ...
                        <ul class="list-unstyled m-0 p-0 d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <li class="flex-shrink-0">
                                <a href="#" class="category-item text-decoration-none">Maintenance</a>
                            </li>
                            <li class="flex-shrink-0">
                                <a href="#" class="category-item text-decoration-none">Support</a>
                            </li>
                            <li class="flex-shrink-0">
                                <a href="#" class="category-item text-decoration-none">Update</a>
                            </li>
                            <li class="flex-shrink-0">
                                <a href="#" class="category-item text-decoration-none">News</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li class="mb-2">
                                <a href="#"
                                    ...
                                    <div class=" flex-shrink-0">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/recent-post.svg"
                                            alt="banner img" class="img-fluid">
                                    </div>
                                    <span class="text-wrap">How to Handle Complex Apps and B2B Interface Design</span>
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="#"
        ...
        <div class="blog-details-card">
            <h3 class="text-clr-blue fs-40 fw-bold mb-4">Cards</h3>
                    ...
                    <div class="col-lg-4">
                        <a href="#" class="details-card-item mb-lg-0 mb-3 d-block text-decoration-none">
                            <div class="d-flex align-items-start gap-2 justify-content-between">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/details-card-img.svg"
                                    alt="banner img" class="img-fluid">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/arrow-outward.svg"
                                    alt="banner img" class="img-fluid">
                            </div>
                            <h4 class="my-3">Libero enim sed</h4>
                            <p>Malesuada nunc vel risus commodo viverra maecenas accumsan lacus. Maecenas pharetra
