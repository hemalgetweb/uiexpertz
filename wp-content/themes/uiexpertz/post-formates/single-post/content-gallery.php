...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-blog format-gallery mb-40'); ?>>
    ...
    <?php if ( !empty( $post_gallery ) ): ?>
        <div class="blog-thumb swiper-container uiexpertz-blog-box-gallery">
            <div class="owl-carousel uiexpertz-blog-slider uiexpertz-has-default-carousel-nav">
                <?php foreach ( $post_gallery as $image ): ?>
                    <div class="owl-slide">
                        <div class="uiexpertz-fz-thumbnail-image uiexpertz-fz-blog-thumbnail-447">
